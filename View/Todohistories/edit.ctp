<div class="actions">
	...
	<ul class="nav nav-pills well well-sm">
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Todohistory.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Todohistory.id'))); ?></li>
...
<?php echo $this->Form->create('Todohistory', array(
	...
	<fieldset>
		<legend><?php echo __('Edit Todohistory'); ?></legend>
	<?php
